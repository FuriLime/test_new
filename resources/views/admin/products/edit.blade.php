                ...
                <div class="x_content">
                    ...
                    <form method="post" action="{{ route('product.update', ['id' => $product->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" value='{{$product->image }}' id="image" name="image" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('image'))
                        ...
                        <div class="form-group{{ $errors->has('product_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" required="required" value="{{ $product->product_name }}" id="product_name" name="product_name" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" required="required" value="{{ $product->description }}" id="description" name="description" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" step="0.01" value="{{ $product->price }}" id="price" name="price" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('price'))
                        ...
                        <div class="form-group{{ $errors->has('cpu') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ $product->infos->cpu }}" id="cpu" name="cpu" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('cpu'))
                        ...
                        <div class="form-group{{ $errors->has('size') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ $product->infos->size }}" id="size" name="size" class="form-control col-md-7 col-xs-12">
                                @if ($errors->has('size'))
                         ...
                         <div class="form-group{{ $errors->has('memory') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" value="{{ $product->infos->memory }}" id="memory" name="memory" class="form-control col-md-7 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" step="1" value="{{ $product->infos->amount }}" id="amount" name="amount" class="form-control col-md-7 col-xs-12">
